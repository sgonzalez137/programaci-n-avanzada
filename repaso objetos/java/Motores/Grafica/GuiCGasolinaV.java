...
public class GuiCGasolinaV extends JFrame implements ActionListener{
    ...
    public void colocarLabel(){
        TituloIntro = new JLabel("A seleccionado un carro Gasolina con motor en V");
